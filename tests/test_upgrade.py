...
@mock.patch("crate.operator.upgrade.get_connection")
async def test_check_reindexing_tables_detects_tables(
    ...
    mock_ctx_manager = mock.AsyncMock()
    mock_ctx_manager.__aenter__.return_value = mock_conn

    async def _connect(*args, **kwargs):
        return mock_ctx_manager

    mock_get_conn.side_effect = _connect
