...
def kopf_runner(request, cratedb_crd):
    ...
    env = {
        "CRATEDB_OPERATOR_CLUSTER_BACKUP_IMAGE": "",
        "CRATEDB_OPERATOR_CLUSTER_BOOTSTRAP_IMAGE": "",
        "CRATEDB_OPERATOR_DEBUG_VOLUME_SIZE": "2Gi",
